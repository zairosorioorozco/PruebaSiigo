...
public class CreateClienteUserInterface {
    ...
    public static final Target SELECT_PERSON_TYPE = Target.the("Type person ").locatedBy("//li[contains(text(),'{0}')]");
    ...
    public static final Target SELECT_LIST_TYPE = Target.the("tYpe Identification ").locatedBy("//li[contains(text(),'{0}')]");
    ...
    public static final Target CONFIRMATION_CREATE_CLIENTE = Target.the("label confirmation").locatedBy("//*[contains(text(),'Tercero guardado exitosamente')]");
